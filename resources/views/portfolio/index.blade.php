                ...
                <section id="about" class="section-padding">
                    ...
                    <div class="card-glassmorphism p-6 mx-auto">
                        ...
                        <p class="text-sm text-gray-300 mb-4">
                            ...
                            performance, security, and an excellent user experience. I also utilize <strong>HTML, CSS,
                                and
                        ...
                        <p class="text-sm text-gray-300 mb-4">
                            ...
                            skills to deliver innovative software solutions. <strong>Recently, I've been actively
                                expanding my
                                expertise into Artificial Intelligence (AI) and Machine Learning (ML), particularly in
                                Natural Language Processing (NLP) with Python libraries like scikit-learn and Hugging
                                Face
                                Transformers.</strong>
                        </p>
                        <p class="text-sm text-gray-300 mb-4">
                        ...
                        <p class="text-sm text-gray-300 mb-0">
                            My goal is to achieve professionalism in web development, <strong>integrate modern AI
                                capabilities
